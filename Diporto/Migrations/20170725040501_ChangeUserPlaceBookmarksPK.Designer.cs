...
namespace Diporto.Migrations
{
    ...
    [Migration("20170725040501_ChangeUserPlaceBookmarksPK")]
    partial class ChangeUserPlaceBookmarksPK
    {
            ...
            modelBuilder.Entity("Diporto.Models.PlacePhoto", b =>
                {
                    ...
                    b.Property<bool>("IsGooglePlacesImage")
                        .HasColumnName("is_google_places_image");
            ...
            modelBuilder.Entity("Diporto.Models.User", b =>
                {
                    ...
                    b.Property<PostgisPoint>("CurrentLocation")
